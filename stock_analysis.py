...
class StockAnalysis:
    ...
    def __init__(self):
        ...
        t4 = Label(root, text='Stock Visualization', font='Times 12 bold')
    ...
    # Creating the main function to analyze the stocks
    def stockmain(self):
        ...
        if endcon - startcon > timedelta(days=100):
            ...
            # Visualizing the stock with the highest return if possible the simple moving average
    ...
    # Creating the function that visualizes the stock prices of the stocks
    def stockdata(self):
        stocks = self.stocks.get()
        startdate = self.startdate.get()
        enddate = self.enddate.get()
    ...
    # Creating the function that visualizes the returns of the stocks
    ...
    # Creating the function that visualizes the volatility of the stocks
    def stockvola(self):
        stocks = self.stocks.get()
        startdate = self.startdate.get()
        enddate = self.enddate.get()
    ...
    # Creating the function that opens all the different websites of the stocks the user wants to analyze
